defmodule AWS.CodeGen.Types do
  ...
  def shape_to_type(_, %AWS.CodeGen.PostService.Shape{type: type}, _module_name) when type in ["float", "double", "long"], do: "float()"
  def shape_to_type(_, %AWS.CodeGen.RestService.Shape{type: type}, _module_name) when type in ["float", "double", "long"], do: "float()"
  def shape_to_type(_, %AWS.CodeGen.PostService.Shape{type: "timestamp"}, _module_name), do: "non_neg_integer()"
  def shape_to_type(_, %AWS.CodeGen.RestService.Shape{type: "timestamp"}, _module_name), do: "non_neg_integer()"
  def shape_to_type(_, %AWS.CodeGen.PostService.Shape{type: "map"}, _module_name), do: "map()"
  def shape_to_type(_, %AWS.CodeGen.RestService.Shape{type: "map"}, _module_name), do: "map()"
  def shape_to_type(_, %AWS.CodeGen.PostService.Shape{type: "blob"}, _module_name), do: "binary()"
  def shape_to_type(_, %AWS.CodeGen.RestService.Shape{type: "blob"}, _module_name), do: "binary()"
  def shape_to_type(:elixir, %AWS.CodeGen.PostService.Shape{type: "string"}, _module_name), do: "String.t()"
  def shape_to_type(:erlang, %AWS.CodeGen.PostService.Shape{type: "string"}, _module_name), do: "string()"
  def shape_to_type(:elixir, %AWS.CodeGen.RestService.Shape{type: "string"}, _module_name), do: "String.t()"
  def shape_to_type(:erlang, %AWS.CodeGen.RestService.Shape{type: "string"}, _module_name), do: "string()"
  def shape_to_type(_, %AWS.CodeGen.PostService.Shape{type: "integer"}, _module_name), do: "integer()"
  def shape_to_type(_, %AWS.CodeGen.RestService.Shape{type: "integer"}, _module_name), do: "integer()"
  def shape_to_type(_, %AWS.CodeGen.PostService.Shape{type: "boolean"}, _module_name), do: "boolean()"
  def shape_to_type(_, %AWS.CodeGen.RestService.Shape{type: "boolean"}, _module_name), do: "boolean()"
  def shape_to_type(_, %AWS.CodeGen.PostService.Shape{type: "enum"}, _module_name), do: "list(any())"
  def shape_to_type(_, %AWS.CodeGen.RestService.Shape{type: "enum"}, _module_name), do: "list(any())"
  def shape_to_type(_, %AWS.CodeGen.PostService.Shape{type: "union"}, _module_name), do: "list()"
  def shape_to_type(_, %AWS.CodeGen.RestService.Shape{type: "union"}, _module_name), do: "list()"
  def shape_to_type(_, %AWS.CodeGen.PostService.Shape{type: "document"}, _module_name), do: "any()"
  def shape_to_type(_, %AWS.CodeGen.RestService.Shape{type: "document"}, _module_name), do: "any()"
